...
namespace DSC.CRM.Integration.API.Models.Requests
{
    ...
    {
        // Tags for the establishment
        public string Tags { get; set; }

        // Indicates if establishment is women specific
        ...
        public DateTime TradeLicenseStartDate { get; set; }
        ...
        public int TotalFemaleAthletes { get; set; }

        public int TotalMaleAthletes { get; set; }
